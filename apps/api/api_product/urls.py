...
from .views import ProductViewSet, ProductCharacteristicsAPI, ProductTypeAPI, ProductVendorAPI
...
urlpatterns = [
    ...
    path('product_vendors/', ProductVendorAPI.as_view(), name='Product Vendors')
]